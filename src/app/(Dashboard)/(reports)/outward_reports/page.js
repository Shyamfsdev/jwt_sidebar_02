...
import ProductCreate from "../../components/product_view/OutwardReports";
import PurchaseItemReport from "../../components/product_view/OutwardItemReport";
...
const OrderList = () => {
  ...
  const fetchData = async (
    ...
    axiosGet
      .get(
        `return_reports_get?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&supplier_id=${supplier_id}&invoice_date=${invoice_date}&delivery_challan=${2}`
      )
      .then((response) => {
  ...
  const HandlePurchaseInvoice = () => {
    const fetchData = async (
      ...
      axiosGet
        .get(
          `return_reports_get?access_token=${access_token}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&delivery_challan=${2}`
        )
        .then((response) => {
  ...
  const handleInvoiceChange = (event, value) => {
    if (value != null) {
      setinvoiceName(value.pur_return_number);
    } else {
      setinvoiceName("");
    }
  };
  ...
  const product_table = [
    ...
    { th: "GST Number", id: "pur_return_number", weigh: "12%", sub_item: [] },
    { th: "Vehicle Number", id: "pur_invoice_number", weigh: "6%", sub_item: [] },
    { th: "Driver Name", id: "pur_invoice_number", weigh: "6%", sub_item: [] },
    { th: "Driver Mobile", id: "pur_invoice_number", weigh: "6%", sub_item: [] },
    {
      th: "Outward Number",
      id: "pur_invoice_number",
      weigh: "6%",
      sub_item: [],
    },
    { th: "Outward Date", id: "return_date", weigh: "8%", sub_item: [] },
    { th: "Created Date", id: "created_f_date", weigh: "12%", sub_item: [] },
    { th: "Created By", id: "created_by", weigh: "12%", sub_item: [] },
    { th: "Against PR / DC", id: "pur_return_status", weigh: "10%", sub_item: [] },
  ...
  const [dateTitle, setDateTitle] = useState("Outward Date");
  ...
  const handleInvoiceTabTwoChange = (event, value) => {
    if (value != null) {
      setinvoiceTabTwoName(value.pur_return_number);
    } else {
  ...
  const product_table_purchase_item = [
    ...
    { th: "Outward Number", id: "tcs_value", weigh: "6%", sub_item: [] },
    { th: "Outward Date", id: "base_value", weigh: "8%", sub_item: [] },
    { th: "Created Date", id: "created_f_date", weigh: "12%", sub_item: [] },
    { th: "Created By", id: "created_by", weigh: "12%", sub_item: [] },
    { th: "Against PR / DC", id: "total_tax", weigh: "10%", sub_item: [] },
    { th: "Total Quantity", id: "total_qty", weigh: "8%", sub_item: [] },
  ...
  const [dateItemTitle, setDateItemTitle] = useState("Outward Date");
            ...
            <Stack direction={"row"} gap={1}>
              ...
              <Box sx={{ mt: 1 }}>
                <Autocomplete
                  ...
                  value={
                    invoiceData.find(
                      (year) => year.pur_return_number === invoiceName
                    ) || null
                  }
                  onChange={(e, value) =>
            ...
            <Stack direction={"row"} gap={1}>
              ...
              <Box sx={{ mt: 1 }}>
                <Autocomplete
                  ...
                  value={
                    invoiceData.find(
                      (year) => year.pur_return_number === invoiceTabTwoName
                    ) || null
                  }
                  onChange={(e, value) =>
