...
import ProductCreate from "../../components/product_view/MismatchReport";
import PurchaseItemReport from "../../components/product_view/MismatchItem";
...
const OrderList = () => {
  ...
  const fetchData = async (
    ...
    axiosGet
      .get(
        `mismatch_report?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&supplier_id=${supplier_id}&pur_entry_number=${pur_entry_number}&inwaed_entry_method=${0}&`
      )
      .then((response) => {
  ...
  const fetchData2 = async (
    ...
    axiosGet
      .get(
        `mismatch_report_item?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&supplier_id=${supplier_id}&invoice_date=${invoice_date}&material_name=${material_name}&item_code=${item_code}`
      )
      .then((response) => {
  ...
  const HandlePurchaseInvoice = () => {
    const fetchData = async (
      ...
      axiosGet
        .get(
          `mismatch_report?access_token=${access_token}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&inwaed_entry_method=${0}`
        )
        .then((response) => {
  ...
  const product_table_purchase_item = [
    ...
    { th: "Received Material Name", id: "material_name", weigh: "6%", sub_item: [] },
    { th: "Received Item Code", id: "material_code", weigh: "6%", sub_item: [] },
    { th: "Received Batch Number", id: "batch_number", weigh: "6%", sub_item: [] },
    { th: "Received Quantity", id: "total_qty", weigh: "8%", sub_item: [] },
    { th: "Mismatch Material Name", id: "mismatch_material_name", weigh: "6%", sub_item: [] },
    { th: "Mismatch Item Code", id: "mismatch_material_code", weigh: "6%", sub_item: [] },
    { th: "Mismatch Batch Number", id: "mismatch_batch_number", weigh: "6%", sub_item: [] },
    { th: "Mismatch Number", id: "mismatch_number", weigh: "6%", sub_item: [] },
    { th: "Mismatch Quantity", id: "mismatch_total_qty", weigh: "8%", sub_item: [] },
    { th: "Invoice Date", id: "invoice_date", weigh: "8%", sub_item: [] },
    { th: "Created Date", id: "created_f_date", weigh: "12%", sub_item: [] },
    { th: "Created By", id: "created_by", weigh: "12%", sub_item: [] },
