...
import ProductCreate from "../../components/product_view/DeliveryChellanMISReport";
import PurchaseItemReport from "../../components/product_view/DeliveryChellanMISItemReport";
...
const OrderList = () => {
  ...
  const fetchData = async (
    ...
    axiosGet
      .get(
        `delivery_chellan_details?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&customer_id=${customer_id}&invoice_date=${invoice_date}`
      )
      .then((response) => {
  ...
  const HandlePurchaseInvoice = () => {
    const fetchData = async (
      ...
      axiosGet
        .get(
          `delivery_chellan_details?access_token=${access_token}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}`
        )
        .then((response) => {
  ...
  const product_table = [
    ...
    {
      th: "Delivery Challan Number",
      id: "pur_return_number",
      weigh: "6%",
      sub_item: [],
    },
    { th: "Return Date", id: "invoice_date", weigh: "8%", sub_item: [] },
    { th: "Salesman Name", id: "salesman_name", weigh: "12%", sub_item: [] },
    { th: "Route ", id: "route_name", weigh: "12%", sub_item: [] },
    { th: "Status", id: "margin_value", weigh: "12%", sub_item: [] },
  ];
  ...
  const product_table_purchase_item = [
    ...
    { th: "Customer Mobile", id: "pur_invoice_id", weigh: "12%", sub_item: [] },
    ...
    { th: "Delivery Challan Number", id: "tcs_value", weigh: "6%", sub_item: [] },
    { th: "Return Date", id: "invoice_date", weigh: "8%", sub_item: [] },
    { th: "Route ", id: "route_name", weigh: "12%", sub_item: [] },
    { th: "Salesman Name", id: "salesman_name", weigh: "8%", sub_item: [] },
    { th: "Status", id: "igst_value", weigh: "12%", sub_item: [] },
  ...
  const tabs = [
    ...
    {
      value: 2,
      name: "Delivery Challan Item Report",
