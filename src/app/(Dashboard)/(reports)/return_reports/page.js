...
import ProductCreate from "../../components/product_view/ReturnReports";
import PurchaseItemReport from "../../components/product_view/ReturnItemReport";
...
const OrderList = () => {
  ...
  const fetchData = async (
    ...
    axiosGet
      .get(
        `return_reports_get?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&supplier_id=${supplier_id}&invoice_date=${invoice_date}&delivery_challan=${0}`
      )
      .then((response) => {
  ...
  const HandlePurchaseInvoice = () => {
    const fetchData = async (
      ...
      axiosGet
        .get(
          `return_reports_get?access_token=${access_token}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&delivery_challan=0`
        )
        .then((response) => {
