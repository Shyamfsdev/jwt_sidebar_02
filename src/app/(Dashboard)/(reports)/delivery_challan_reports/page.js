...
import ProductCreate from "../../components/product_view/DeliveryReports";
import PurchaseItemReport from "../../components/product_view/DeliveryItemReports";
...
const OrderList = () => {
  ...
  const fetchData = async (
    ...
    axiosGet
      .get(
        `return_reports_get?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&supplier_id=${supplier_id}&invoice_date=${invoice_date}&delivery_challan=${1}`
      )
      .then((response) => {
  ...
  const HandlePurchaseInvoice = () => {
    const fetchData = async (
      ...
      axiosGet
        .get(
          `return_reports_get?access_token=${access_token}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&delivery_challan=${1}`
        )
        .then((response) => {
  ...
  const [dateTitle, setDateTitle] = useState("DC Date");
  ...
  const product_table_purchase_item = [
    ...
    { th: "DC Number", id: "tcs_value", weigh: "6%", sub_item: [] },
    { th: "DC Date", id: "base_value", weigh: "8%", sub_item: [] },
    { th: "Created Date", id: "created_f_date", weigh: "12%", sub_item: [] },
    { th: "Created By", id: "created_by", weigh: "12%", sub_item: [] },
  ...
  const [dateItemTitle, setDateItemTitle] = useState("DC Date");
  ...
  const tabs = [
    {
      value: 1,
      name: "Delivery Challan Reports",
      content: <TabContext value={1} />,
    },
    {
      value: 2,
      name: "Delivery Challan Item Reports",
