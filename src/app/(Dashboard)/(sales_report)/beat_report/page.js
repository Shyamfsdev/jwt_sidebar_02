...
import ProductCreate from "../../components/sales_view/BeatReport";
...
import PurchaseItemReport from "../../components/sales_view/BeatItemsReport";
...
const OrderList = () => {
  ...
  const fetchData = async (
    ...
    axiosGet
      .get(
        `beat_reports_get?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&sales_man_id=${route_id}&table_name=${table_name}`
      )
      .then((response) => {
  ...
  const fetchData2 = async (
    ...
    axiosGet
      .get(
        `picklist_item_reports_get?access_token=${access_token}&page=${limit}&items_per_page=${end}&search_input=${searchValue}&from_date=${createdStartDate}&to_date=${createdEndDate}&order_type=${order_type}&order_field=${order_field}&route_id=${route_id}&delivery_date=${delivery_date}&material_name=${material_name}&item_code=${item_code}&hsn_code=${hsn_code}&division=${division}`
      )
      .then((response) => {
  ...
  const Salesman_Reports = [
    ...
    {lable:'Invoice Return Report',value:'invoice_return_report'},
    {lable:'Invoice Replacement Report',value:'invoice_replacement_report'},
    {lable:'Damage Goods Report',value:'damage_goods_report'}
  ];
  ...
  if(requestMethod === 'sales_report'){
    product_table = [
      ...
      { th: "GST Number", id: "sal_invoice_status", weigh: "12%", sub_item: [] },
      ...
      { th: "Status", id: "sal_invoice_status_org", weigh: "10%", sub_item: [] },
  ...
  if(requestMethod === 'picklist_report'){
    product_table = [
      ...
      { th: "Picklist Number", id: "pick_list_number", weigh: "12%", sub_item: [] },
      {
        th: "Vehicle Number",
        id: "vechicle_no",
        weigh: "6%",
  ...
  if(requestMethod === 'invoice_return_report'){
    product_table = [
      ...
      { th: "Salesman Mobile", id: "salesman_no", weigh: "12%", sub_item: [] },
      { th: "Route", id: "route_id", weigh: "12%", sub_item: [] },
      { th: "Return Number", id: "pick_list_number", weigh: "12%", sub_item: [] },
      {
        th: "Vehicle Number",
        id: "vechicle_no",
        weigh: "6%",
      ...
      { th: "Driver Name", id: "driver_name", weigh: "8%", sub_item: [] },
      { th: "Driver No", id: "driver_no", weigh: "12%", sub_item: [] },
      { th: "Return Date", id: "delivery_date", weigh: "12%", sub_item: [] },
      { th: "Created Date", id: "created_date", weigh: "10%", sub_item: [] },
      { th: "Created By", id: "created_by", weigh: "10%", sub_item: [] },
  ...
  const product_table_purchase_item = [
    ...
    { th: "Route", id: "route_name", weigh: "12%", sub_item: [] },
    ...
    { th: "Material Quantity", id: "total_qty", weigh: "8%", sub_item: [] },
      ...
      return (
        <Box className="reports_bax_sub">
          ...
          >
            ...
            {requestMethod === 'picklist_report' && <Box sx={{ mt: 1 }}>
                <Autocomplete
                  margin="normal"
                  variant="outlined"
                  style={{ marginTop: "0px" }}
            ...
            {requestMethod === 'invoice_return_report' && <Box sx={{ mt: 1 }}>
                <Autocomplete
                  margin="normal"
                  variant="outlined"
                  style={{ marginTop: "0px" }}
            ...
            {requestMethod === 'invoice_replacement_report' && <Box sx={{ mt: 1 }}>
                <Autocomplete
                  margin="normal"
                  variant="outlined"
                  style={{ marginTop: "0px" }}
            ...
            {requestMethod === 'damage_goods_report' && <Box sx={{ mt: 1 }}>
                <Autocomplete
                  margin="normal"
                  variant="outlined"
                  style={{ marginTop: "0px" }}
          ...
          <Box sx={{ padding: "10px" }}>
            {requestMethod === 'sales_report' && <SalesProductCreate product_table={product_table} orderMaterial={data} total_amount={totalPayable} total_quantity={totalQuantity} />}
            {requestMethod === 'picklist_report' && <PickProductCreate product_table={product_table} orderMaterial={data} total_amount={totalPayable} total_quantity={totalQuantity} />}
            {requestMethod === 'invoice_return_report' && <ProductCreate product_table={product_table} orderMaterial={data} />}
            {requestMethod === 'invoice_replacement_report' && <ProductCreate product_table={product_table} orderMaterial={data} />}
            {requestMethod === 'damage_goods_report' && <ProductCreate product_table={product_table} orderMaterial={data} />}
          </Box>
        </Box>
      );
    } else if (tabsValue === 2) {
            ...
            <Stack direction={"row"} gap={1}>
              <Box sx={{ mt: 1 }}>
                <Autocomplete
                  ...
                  value={
                    SalesmanMaster.find(
                      (year) => year.salesman_name === SalesmanTabTwoName
                    ) || null
                  }
                  onChange={(e, value) =>
