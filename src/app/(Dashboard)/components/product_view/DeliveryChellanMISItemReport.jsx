            ...
            {orderMaterial?.map((row, index) => (
              ...
              >
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.[0]?.customer_datils?.contact_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.[0]?.customer_datils?.address?.state}
                </TableCell>
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.[0]?.pur_return_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.[0]?.return_date}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.[0]?.route_name}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.[0]?.sales_man_name}
                </TableCell>
                ...
                >
                  <Box style={{ padding: "0px" }}>
                    <span
                      className={`table_body_style_fab arrival_${row.purchase_details?.[0]?.pur_return_status_org}`}
                      sx={{ width: "20%" }}
                    >
                      {row.purchase_details?.[0]?.pur_return_status}
                    </span>
                  </Box>
                </TableCell>
