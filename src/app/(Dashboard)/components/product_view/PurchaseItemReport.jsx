            ...
            {orderMaterial.map((row, index) => (
              ...
              >
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.pur_invoice_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                ...
                >
                  <Box style={{ padding: "0px" }}>
                    <span
                      className={`table_body_style_fab arrival_${row.purchase_details?.pur_invoice_status_org}`}
                      sx={{ width: "20%" }}
                    >
                      {row.purchase_details?.pur_invoice_status}
                    </span>
                  </Box>
                </TableCell>
                <TableCell
