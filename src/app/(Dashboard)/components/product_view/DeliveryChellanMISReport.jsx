            ...
            {orderMaterial?.map((row, index) => (
              ...
              >
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.customer_data?.contact_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.customer_data?.address?.district}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                ...
                >
                  <Box style={{ padding: "0px" }}>
                    <span
                      className={`table_body_style_fab arrival_${row.pur_return_status_org}`}
                      sx={{ width: "20%" }}
                    >
                      {row.pur_return_status}
                    </span>
                  </Box>
                </TableCell>
