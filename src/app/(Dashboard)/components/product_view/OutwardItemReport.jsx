            ...
            {orderMaterial.map((row, index) => (
              ...
              >
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.vehicle_details?.driver_name}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.vehicle_details?.driver_mobile}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.pur_return_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.return_date}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.return_order_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.return_order_status === 0
                    ? row.total_qty.toFixed(1)
                    : "--"}
                </TableCell>
                <TableCell
                  className="table_cell_3"
