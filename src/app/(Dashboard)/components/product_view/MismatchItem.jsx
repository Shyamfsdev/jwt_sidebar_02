            ...
            <TableRow>
              {product_table.map((res) => (
                <TableCell
                  key={res.id}
                  align="center"
                  sx={{ padding: "8px 8px", border: "1px solid #ffffff5e" }}
                >
            ...
            {orderMaterial.map((row, index) => (
              ...
              >
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {(row.mismatch_material_qty)?.toFixed(2)}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
