              ...
              >
                ...
                >
                  <Box style={{ padding: "0px" }}>
                    <span
                      className={`table_body_style_fab arrival_${row.purchase_entry_status_org}`}
                      sx={{ width: "20%" }}
                    >
                      {row.purchase_entry_status}
                    </span>
                  </Box>
                </TableCell>
                <TableCell
                  ...
                  align="center"
                >
                  {row.material_list[0]?.total_qty !== null && row.material_list[0]?.total_qty !== undefined ? row.material_list[0]?.total_qty.toFixed(2) : "NA"}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.material_list[0]?.total_amount !== null && row.material_list[0]?.total_amount !== undefined ? row.material_list[0]?.total_amount.toFixed(2) : "NA"}
                </TableCell>
