              ...
              >
                ...
                >
                  <Autocomplete
                    ...
                    value={
                      row.uom_list?.find(
                        (year) => year.uomName === row.uom
                      ) || null
                    }
                    onChange={(event, value) =>
                      handleProductChange(event, value, index, "uom_list")
                    }
                    onFocus={() => handleFocus(index)}
                    getOptionLabel={(val) => val.uomName}
                    required
                    id="supplier"
                    renderInput={(params) => (
                      <TextField
                ...
                >
                  <TextField
                    ...
                    onChange={(event, value) =>
                      handleProductChange(event, value, index, "trade_discount")
                    }
                    name="trade_discount"
                    inputProps={{
                      style: {
                ...
                >
                  <Tooltip placement="top" title="Delete" >
                    <IconButton onClick={() => handleRemoveProductDetails(index)} onFocus={() => handleFocus(index)} className='delete_icon_style'>
                        <DeleteIcon />
                    </IconButton>
                    </Tooltip>
                </TableCell>
