    ...
    <TableHead sx={{ bgcolor: "#F0F0F0" }}>
      <TableRow>
        ...
        {tableHead.map((headCell) => (
          ...
          >
            {headCell.action ? (
              <Typography className="table_cell" color="primary" fontWeight={"bold"}>
                {headCell.label}
              </Typography>
            ) : (
              <TableSortLabel
  ...
  return (
    <Box sx={{ width: "100%", pt: 2 }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        ...
        <TableContainer id="table-container" style={{height: '75vh',overflow: "auto"}}>
          <Table
          stickyHeader
            sx={{ minWidth: 750 }}
                ...
                {tableRow.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell
                        padding="checkbox"
                        style={{borderBottom:'1px solid #e5eaef'}}
