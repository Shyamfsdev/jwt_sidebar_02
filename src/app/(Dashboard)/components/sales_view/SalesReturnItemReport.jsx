            ...
            {orderMaterial.map((row, index) => (
              ...
              >
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.customer_data?.contact_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.customer_data?.address?.district}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.customer_data?.gst_no}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.sales_return_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
