            ...
            {orderMaterial?.map((row, index) => (
              ...
              >
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.salesman_name}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.salesman_number?.mobile_number ? row.purchase_details?.salesman_number.mobile_number : 'NA'}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.route_name}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details.pick_list_number}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                ...
                <TableCell
                  ...
                  align="center"
                >
                  {row.purchase_details?.vehicle_details?.vehicle_number ? row.purchase_details?.vehicle_details?.vehicle_number : 'NA'}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                  ...
                  align="center"
                >
                  {row.purchase_details?.delivery_date ? row.purchase_details?.delivery_date : 'NA'}
                </TableCell>
                <TableCell
                  className="table_cell_3"
                  sx={{
                ...
                >
                  <Box style={{ padding: "0px" }}>
                    <span
                      className={`table_body_style_fab arrival_${row.purchase_details?.pick_list_status_org}`}
                      sx={{ width: "20%" }}
                    >
                      {row.purchase_details?.pick_list_status}
                    </span>
                  </Box>
                </TableCell>
                <TableCell
