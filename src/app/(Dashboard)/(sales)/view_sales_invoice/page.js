...
import SalesCreate from "../../components/product_view/SalesCreate";
    ...
    const fetchData = async (access_token, data_uniq_id) => {
      axiosGet
        ...
        .then((response) => {
          ...
          setinvoiceNumber(response.data.data[0]?.sify_invoice_number);
          setdocumentNumber(response.data.data[0]?.sify_doc_number);
          ...
          <>
            <Paper sx={{ p: 1, mb: 1 }}>
              <Stack direction={"row"} gap={2}>
                <Box
                  className="master_create_style_withOut_Ps"
                  sx={{ px: 1, width: "45%" }}
                >
                  <Box sx={{ mb: 2, mt: 1 }}>
                    <Typography
                  ...
                  <div className="display_flex">
                    <span className="fontInput2"> Contact Number : {customerMobile}</span>
                  </div>
                  <div className="display_flex">
              ...
              <Stack direction={"row"} gap={2}>
                ...
                >
                  ...
                  <div className="display_flex">
                    <span className="fontInput2">
                      Sify Invoice Number : {invoiceNumber}
                    </span>
                  </div>
                  <div className="display_flex">
                    <span className="fontInput2">
                      Sify Document Number : {documentNumber}
                    </span>
                  </div>
                  <div className="display_flex">
                    <span className="fontInput2">
            ...
            <Paper sx={{ p: 1, mb: 1 }}>
              <Box sx={{ px: 1 }}>
                ...
                />
                <TotalAmount amount={formattedTotalPayable} />
              </Box>
            </Paper>
          </>
        </Box>
