...
import SalesCreate from "../../components/product_view/SalesReplacementList";
...
const EmployeeCreate = () => {
    ...
    const fetchData = async (access_token, data_uniq_id) => {
      axiosGet
        ...
        .then((response) => {
          ...
          setreceiverCustomerName(response.data.data[0]?.ref_customer_name);
          setreceiverCustomerAddress(response.data.data[0]?.ref_customer_data?.address);
          setreceiverCustomerGst(response.data.data[0]?.ref_customer_data?.gst_no);
          setreceiverCustomerMobile(response.data.data[0]?.ref_customer_data?.contact_number);
  ...
  const product_table = [
    ...
    { th: "Material Quantity", id: "qty", weigh: "10%", sub_item: [] },
    { th: "Replacement Quantity", id: "return_qty", weigh: "10%", sub_item: [] },
            ...
            <Paper sx={{ p: 1, mb: 1 }}>
              ...
              <Stack direction={"row"} gap={2}>
                ...
                >
                  ...
                  <div className="display_flex">
                    <span className="fontInput2">
                    Customer Name : {receiverCustomerName}
                    </span>
                  </div>
                  <div className="display_flex">
                    <span className="fontInput2"> Customer Name : {receiverCustomerMobile}</span>
                  </div>
                  <div className="display_flex">
                    <span className="fontInput2">Gst No : {receiverCustomerGst}</span>
                  </div>
                </Box>
                <Box
                  className="master_create_style_withOut_P"
                ...
                >
                  ...
                  <div className="display_flex">
                    <span className="fontInput2">
                      {receiverCustomerAddress?.flatStreet},
                    </span>
                  </div>
                  <div className="display_flex">
                    <span className="fontInput2">
                      {receiverCustomerAddress?.district},
                      {receiverCustomerAddress?.state} -
                      {receiverCustomerAddress?.pincode}.
                    </span>
                  </div>
                </Box>
              </Stack>
              ...
              >
                <Box sx={{ mb: 2, mt: 1 }}>
                  <Typography
                    ...
                    color={"primary"}
                  >
                    Reference Invoice Replacement Details
                  </Typography>
                </Box>
                <div className="display_flex">
                  <span className="fontInput2">
                    Invoice Replacement Number : {invoiceNumber}
                  </span>
                </div>
                <div className="display_flex">
                  <span className="fontInput2">
