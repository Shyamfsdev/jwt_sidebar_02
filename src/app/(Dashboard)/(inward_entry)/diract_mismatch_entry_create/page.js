...
import ProductCreate from "../../components/inwardentry_create/MismatchCreate";
...
const EmployeeCreate = () => {
  ...
  const product_table = [
    ...
    {
      th: "Billed Base Value",
      id: "mismatch_base_value",
      weigh: "20%",
      sub_item: [],
    },
    { th: "Received Material Code", id: "material_code", weigh: "15%", sub_item: [] },
    { th: "Received Material Name", id: "material_name", weigh: "12%", sub_item: [] },
    { th: "Received UOM", id: "uom", weigh: "6%", sub_item: [] },
    { th: "Received Division", id: "division", weigh: "8%", sub_item: [] },
    { th: "Received Batch No.", id: "batch_number", weigh: "12%", sub_item: [] },
    { th: "Received HSN Code", id: "hsn_code", weigh: "12%", sub_item: [] },
    { th: "Received Material Qty", id: "qty", weigh: "10%", sub_item: [] },
    { th: "Received Base Value", id: "base_value", weigh: "8%", sub_item: [] },
    {
      th: "Received Invoice Discount",
      id: "invoice_discount",
      weigh: "8%",
      sub_item: [],
    },
    { th: "Received Other Discount", id: "other_discount", weigh: "8%", sub_item: [] },
    {
      th: "Received GST Values",
      id: "gst_value",
      weigh: "8%",
      sub_item: [
    ...
    { th: "Received Cess Rate", id: "cess_rate", weigh: "10%", sub_item: [] },
    { th: "Received Cess Value", id: "cess_value", weigh: "4%", sub_item: [] },
    {
      th: "Received Additional Cess Value",
      id: "additional_cess_value",
      weigh: "10%",
      sub_item: [],
    },
    { th: "Received Total Tax", id: "total_tax", weigh: "4%", sub_item: [] },
    { th: "Received TCS Rate", id: "tcs_rate", weigh: "10%", sub_item: [] },
    { th: "Received TCS Value", id: "tcs_value", weigh: "4%", sub_item: [] },
  ...
  const HandleProductMismatchMasterCode = (index, value) => {
    const fetchData = async (
      access_token,
      searchValue,
      createdStartDate,
        ...
        .then((res) => {
          if (res.data.action == "success") {
            ...
            if (
              ...
              const value = res.data?.data[0];
              const newfield = [...orderMaterial];
              newfield[index].mismatch_material_id = value.data_uniq_id;
              newfield[index].mismatch_material_name = value.product_name;
              newfield[index].mismatch_batch_list = value.batch_details;
              newfield[index].mismatch_base_value = value.base_value;
              setorderMaterial(newfield);
            } else {
              const value = res.data?.data[0];
              const newfield = [...orderMaterial];
              newfield[index].mismatch_material_id = "";
              newfield[index].mismatch_material_name = "";
              newfield[index].mismatch_batch_list = [];
              newfield[index].mismatch_base_value = "";
              setorderMaterial(newfield);
            }
          }
        });
  ...
  const handleProductChange = (event, value, index, ref) => {
    ...
    if (value !== undefined && value !== null) {
      ...
      if (ref == "mismatch_batch_number") {
        newfield[index].mismatch_batch_id = value.batch_id;
        newfield[index].mismatch_batch_number = value.batch_number;
        newfield[index].mismatch_base_value = value.base_value;
        setorderMaterial(newfield);
      }
      ...
      if (ref === "material_code") {
        ...
        setorderMaterial(newfield);
      } else if (ref === "mismatch_material_code") {
        newfield[index].mismatch_material_code = event.target.value;
        HandleProductMismatchMasterCode(index, event.target.value);
        setorderMaterial(newfield);
      ...
      } else if (ref === "mismatch_material_qty") {
        if (!isNaN(event.target.value) && event.target.value >= 0) {
          newfield[index].mismatch_material_qty = event.target.value;
          setorderMaterial(newfield);
        }
