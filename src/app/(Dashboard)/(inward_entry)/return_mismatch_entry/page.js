...
const EmployeeCreate = () => {
  ...
  const product_table = [
    ...
    { th: "Received Material Name", id: "material_name", weigh: "19%", sub_item: [] },
    { th: "UOM", id: "uom", weigh: "12%", sub_item: [] },
    { th: "Received Batch No.", id: "batch_number", weigh: "17%", sub_item: [] },
    { th: "Received Material Qty", id: "qty", weigh: "14%", sub_item: [] },
