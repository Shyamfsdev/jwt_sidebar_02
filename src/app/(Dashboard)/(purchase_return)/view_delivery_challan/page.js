...
const EmployeeCreate = () => {
    ...
    const fetchData = async (access_token, pur_invoice_id) => {
      axiosGet
        ...
        .then((response) => {
          ...
          setsupplierMobile(response.data.data[0]?.customer_data?.contact_number);
  ...
  const product_table = [
    ...
    { th: "Material Amount", id: "qty", weigh: "10%", sub_item: [] },
  ];
          ...
          <>
            <Paper sx={{ p: 1, mb: 1 }}>
              ...
              >
                ...
                <div className="display_flex">
                  <span className="fontInput2">
                    Delivery Challan Number : {invoiceNumber}
                  </span>
                </div>
                <div className="display_flex" style={{marginTop:'5px'}}>
                  <span className="fontInput2">
                    Delivery Challan Date : {invoiceDate}
                  </span>
                </div>
                <div className="display_flex" style={{marginTop:'5px'}}>
                  <span className="fontInput2">
