...
const EmployeeCreate = () => {
  ...
  const EmployeeCreateMaster = async () => {
    ...
    const mdata = {
      ...
      purchase_entry_return_againt: "entry_order",
    ...
    axiosPost.post(`purchase_return_entry`, mdata).then((res) => {
      ...
      if (res.data.action_status === "Error") {
        ...
        const successMessage = "Outward Entry Created Successfully";
          ...
          <>
            <Paper sx={{ p: 1, mb: 1 }}>
              ...
              <Stack direction={"row"} gap={2}>
                ...
                >
                  <Box sx={{ mb: 2, mt: 1 }}>
                    <Typography
                      ...
                      color={"primary"}
                    >
                      Reference Return Details
                    </Typography>
                  </Box>

                  <Stack direction={"row"} gap={1}>
                    <Box sx={{ my: 1, width: "60%" }}>
                      <TextField
                        id="outlined-basic"
                ...
                <Box
                  className="master_create_style_withOut_P"
                  sx={{ px: 1, width: "22%", marginTop: "10px" }}
                >
                  <Box sx={{ mb: 2, mt: 1 }}>
                    <Typography
                      variant="p"
