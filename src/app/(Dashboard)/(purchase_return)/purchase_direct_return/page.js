...
import ProductCreate from "../../components/product_create/PurchaseReturnProduct";
...
const EmployeeCreate = () => {
        ...
        .then((res) => {
          if (res.data.action == "success") {
            ...
            if (
              ...
              console.log(Number(invoice_tax));
              console.log(newfield[index].free_stock);
  ...
  const TotalComponent = () => {
    return <TotalAmount amount={(totalPayable).toFixed(2)} qty={(totalQunatity).toFixed(2)} order_material={orderMaterial} state_user={1} />;
  };
